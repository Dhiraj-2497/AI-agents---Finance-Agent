A lightweight, AI-powered agent built with modern language model tools that can process natural language commands and perform simple tasks—all inspired by this tutorial.
